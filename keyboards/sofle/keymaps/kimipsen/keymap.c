...
qk_tap_dance_action_t tap_dance_actions[] = {
  [TD_1_F11] = ACTION_TAP_DANCE_DOUBLE(KC_1, KC_F11),
...
[_QWERTY] = LAYOUT( \
  KC_GRV,   TD(TD_1_F11),   TD(TD_2_F2),    TD(TD_3_F3),    TD(TD_4_F4),    TD(TD_5_F5),                      TD(TD_6_F6),    TD(TD_7_F7),    TD(TD_8_F8),    TD(TD_9_F9),    TD(TD_0_F10),  KC_GRV, \
  KC_ESC,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  KC_BSPC, \
  KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_QUOT, \
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     LALT(KC_PSCREEN), KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
...
[_LOWER] = LAYOUT( \
  ...
  _______,  KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______,       RCS(KC_M), KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, _______, \
 ...
 */
  ...
  XXXXXXX , XXXXXXX,CG_TOGG, SH_TG,      XXXXXXX,  XXXXXXX,                     XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX, \
...
// 'MW_logoikon_32x32px_RGB', 32x32px
static const char PROGMEM mw_logo[] = {
    
};
...
static void print_wpm_narrow(void) {
    oled_write_raw_P(mw_logo, sizeof(mw_logo));
    oled_set_cursor(0,8);
